...
class Icon extends HTMLElement {
    ...
    static en = {A:'Attack',D:'Defense',V:'Vitality',SA:'Special attack',SD:'Special defense',CAC:'Critical attack chance',CAD:'Critical attack damage',CAR:'Critical attack resistance',HP:'HP recovery',MP:'MP recovery',TR:'Taint resistance',CD:'Counter defense',GP:'GP gain',HS:'Hell spear',HSC:'Hell spear chance',BAD:'Back attack damage'};
    static zh = {A:'攻擊力',D:'防禦力',V:'生命力',SA:'必殺攻擊力',SD:'必殺防禦力',CAC:'暴擊率',CAD:'暴擊傷害',CAR:'暴擊抵抗',HP:'HP 回復',MP:'MP 回復',TR:'侵蝕抵抗',CD:'克制抵抗',GP:'GP 獲得',HS:'地獄之矛',HSC:'地獄之矛率',BAD:'背擊傷害'};
